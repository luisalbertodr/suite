-- agenda_dual_update fallaba en producción: user_profiles sin columna display_name.
-- resolve_dunasoft_codusu usaba up.display_name → 42703 al modificar/borrar citas.
...
COMMENT ON FUNCTION dunasoft.resolve_dunasoft_codusu(uuid, uuid, jsonb) IS
  'Código usuario Style (planinc): payload.codusu, nombre empleado vinculado, email o SUITE.';
