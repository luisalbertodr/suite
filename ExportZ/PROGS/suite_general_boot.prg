* Suite sync v2 + bootstrap — #INCLUDE al inicio de general.prg (antes del codigo ejecutable).
* VFP: TYPE() solo resuelve UDF definidas antes en el mismo programa principal.
