...
# schtasks remoto escribe "Acceso denegado" en stderr; con EAP Stop aborta el deploy.
...
if ($taskCode -eq 0) {
    ...
    Write-Warning "No se pudo registrar $AgentTaskName (Acceso denegado a schtasks remoto). El agente arranca con IniciarStyle.bat o reinicia manualmente en la VM."
}
