...
export const WHATSAPP_MESSAGE_TEMPLATE_VARS = [
  ...
  { key: 'respuesta_zona', description: 'Zona corporal o facial elegida en el formulario Meta' },
  { key: 'propuesta_dia_1', description: 'Próximo día laborable propuesto (recordatorio)' },
  { key: 'propuesta_dia_2', description: 'Segundo día laborable propuesto (recordatorio)' },
