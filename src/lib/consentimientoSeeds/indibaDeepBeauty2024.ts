/** Texto base del consentimiento INDIBA® Deep Beauty (modificado 2024, LIPOOUT). */
export const INDIBA_DEEP_BEAUTY_2024_CONTENT = `DOCUMENTO DE CONSENTIMIENTO INFORMADO
...
El/la beneficiario/a del tratamiento puede revocar el consentimiento prestado en cualquier momento, mediante solicitud escrita y firmada.`;

export const INDIBA_DEEP_BEAUTY_2024_META = {
  codigo: 'indiba_deep_beauty_2024',
  tipo: 'Radiofrecuencia INDIBA',
  titulo: 'Consentimiento INDIBA® Deep Beauty (2024)',
  keywords: 'indiba,radiofrecuencia,capacitiva,resistiva,448,deep beauty,deep beauty',
  orden: 10,
} as const;
