...
const DEFAULT_STAGES: Array<Omit<MarketingLeadStageInsert, 'company_id'>> = [
  {
    name: DEFAULT_INTAKE_STAGE_NAME,
    position: 0,
    color: '#22c55e',
    is_default_intake: true,
    is_appointment_intake: false,
    is_presentada: false,
    is_won: false,
  },
  {
    name: 'Formulario+Agenda ficticia',
    position: 1,
    color: '#3b82f6',
    is_default_intake: false,
    is_appointment_intake: true,
    is_presentada: false,
    is_won: false,
  },
  {
    name: '¡Aún no te ha escuchado!',
    position: 2,
    color: '#f59e0b',
    is_default_intake: false,
    is_appointment_intake: false,
