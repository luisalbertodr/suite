...
interface AlbaranSalidaViewProps {
  deliveryNote: DeliveryNote;
  onClose: () => void;
  onEdit: () => void;
}

export const AlbaranSalidaView: React.FC<AlbaranSalidaViewProps> = ({ 
  deliveryNote, 
  onClose, 
  onEdit 
}) => {
  ...
  const { data: customer } = useQuery({
    ...
    queryFn: async () => {
      const { data, error } = await supabase
        .from('customers')
        .select('*')
        .eq('id', deliveryNote.customer_id)
        .single();
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-3">
            ...
            <h1 className="text-2xl font-bold text-gray-900">
              Albarán de Salida {deliveryNote.number}
            </h1>
          </div>
        ...
        >
          ...
          <div className="flex justify-between items-start mb-6">
            ...
            <div className="text-right">
              <h1 className="text-2xl font-bold text-blue-600 mb-1">ALBARÁN DE SALIDA</h1>
