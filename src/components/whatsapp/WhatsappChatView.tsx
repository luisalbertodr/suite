...
import { WhatsappGroupJoinRequestsPanel } from '@/components/whatsapp/WhatsappGroupJoinRequestsPanel';
...
export const WhatsappChatView: React.FC<Props> = ({
  ...
  return (
    ...
    <div className="relative z-[1] flex h-full min-h-0 flex-col overflow-hidden">
      ...
      {isGroup ? <WhatsappGroupJoinRequestsPanel chatId={chat.chat_id} /> : null}
